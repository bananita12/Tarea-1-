...
def Percentil(d):
    """
    Calcula el primer cuartil (Q1) y el tercer cuartil (Q3) de un conjunto de datos.

    Args:
        d (list): Una lista de números que representa el conjunto de datos.

    Returns:
        tuple: Una tupla que contiene los valores de Q1 y Q3.

    El código ordena la lista de datos 'd' y luego calcula los cuartiles Q1 y Q3.
    Q1 delimita el 25% inferior de los datos ordenados, mientras que Q3 delimita el 25% superior.
    Si la longitud de 'd' es un múltiplo de 4, se utilizan cálculos específicos,
    de lo contrario, se realizan cálculos ligeramente diferentes.
